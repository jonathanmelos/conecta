...
<?php
    ...
    <ul class='list-group mb-3'>
        <li class='list-group-item d-flex justify-content-between lh-sm'>
            <div>
                <h3 class='my-0'> $n</h6>
                <form action='modificar_fecha_bd.php' method='post'>
				<small class='text-body-secondary'>Incia el plan el: <br> 
				<input type='hidden' name='documento' value='$documento2'>
                <input type='hidden' name='sec' value='$sec'>
                <input type='date' class='form-control' id='fecha' name='fecha_i' value='$fi'>
                 <br>
				  </small>
                <input type='date' class='form-control' id='fecha' name='fecha_f' value='$ff'>
				  </small>
				
			
            <button type='submit' class='btn btn-warning mb-2' >Aceptar cambios</button>
