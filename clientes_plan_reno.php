...
?>	
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="date" class="form-control" id="inputText3" placeholder="fecha_inicio" value= "<?php echo $fechaActual; ?>" name="fecha_inicio" ><br>
    </div>	 
  </div>
 ...
 <div class="d-grid gap-2 col-6 mx-auto">
    ...
    <input type="submit"  class="btn btn-success btn-lg "  value="Renovar Plan">
</div> 	 
</form>
