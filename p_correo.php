...
<h4 class="d-flex justify-content-between align-items-center mb-3"> 
		<span class="text-primary">Organizar correro:  </span></h4> <br>
		
<form action="p_llamada_in.php" method="post">
	<input type="hidden" class="form-control" id="ld" name="ld" value="<?php echo $ld ?>" >
	<input type="hidden" class="form-control" id="accion" name="accion" value="co" >
...
<div class="form-group row">
    <div class="form-group col-md-12">
		<br>
      <button type="submit" class="btn btn-primary btn-lg btn-block ">Programar Correo</button>		
	</div>
 </div>	
	...
	<h4 class="d-flex justify-content-between align-items-center mb-3"> 
		<span class="text-primary">Programar correo a:  </span></h4>	
...
";
$sql = "SELECT * FROM leads WHERE estado = '$ld' AND nivel <100 AND telefono IS NOT NULL AND correo <> ''";
