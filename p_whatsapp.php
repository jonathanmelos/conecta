...
<h4 class="d-flex justify-content-between align-items-center mb-3"> 
		<span class="text-primary">Organizar whatsapp:  </span></h4> <br>
		
<form action="p_llamada_in.php" method="post">
	<input type="hidden" class="form-control" id="ld" name="ld" value="<?php echo $ld ?>" >
	<input type="hidden" class="form-control" id="accion" name="accion" value="wp" >
...
<div class="form-group row">
    <div class="form-group col-md-12">
		<br>
      <button type="submit" class="btn btn-primary btn-lg btn-block ">Enviar Whatsapp</button>		
	</div>
 </div>	
	...
	<a href="plantilla_wp.php">
		 
		 <button type="button" class="btn btn-outline-info">Plantillas Whatsapp </button>  <br>
	   </a> <br>
	<h4 class="d-flex justify-content-between align-items-center mb-3"> 
		<span class="text-primary">Enviar Whatsapp a:  </span></h4>	
