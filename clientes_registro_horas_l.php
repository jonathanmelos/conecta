...
<form action="clientes_insertar_horas.php" method="post" autocomplete="off">
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputText3" placeholder="cédula / pasaporte" name="documento2" required  value="<?php echo $documento ?>"><br>
    </div>
  </div>
  <div class="form-group row">
    <label for="inputText3" class="col-sm-2 col-form-label"  >Nombre: </label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputText3" placeholder="nombre" value="<?php echo $nombre ?>" name="nombre" required><br>
    </div>
  </div>
